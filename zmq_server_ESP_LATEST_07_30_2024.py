    ...
    if True:
        ...
        if True:
            ...
            if master_ID == nano_ID:
                ...
                # WIRELESS
                command = "k4arecorder --external-sync sub --sync-delay 0 -e 20000 -r 30 -l 1 -d NFOV_UNBINNED -c 1080p " + case_path + "/" + "Animal_" + str(case_number) + "_nano_" + server_no + ".mkv"
                
                os.system("export DISPLAY=:0")
                time.sleep(2)
            else:
                if nano_ID == '13' or nano_ID == '15':
                    command = "k4arecorder --external-sync sub --sync-delay " + str((int(nano_ID[1])) * 160) + " -e 20000 -r 30 -l 1 -d NFOV_UNBINNED -c 1080p " + case_path + "/" + "Animal_" + str(case_number) + "_nano_" + server_no + ".mkv"
                    os.system("export DISPLAY=:0")

                elif nano_ID == '20': # we do not want the offset to be 0*160ms
                    command = "k4arecorder --external-sync sub --sync-delay " + str((10 * 160)) + " -e 20000 -r 30 -l 1 -d NFOV_UNBINNED -c 1080p " + case_path + "/" + "Animal_" + str(case_number) + "_nano_" + server_no + ".mkv"
                    os.system("export DISPLAY=:0")
