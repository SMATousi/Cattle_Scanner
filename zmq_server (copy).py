        ...
        if sync_delay:
            ...
            if master_ID == nano_ID:
                ...
                if nano_ID == '13' or nano_ID == '15':
                    command = "k4arecorder --external-sync sub --sync-delay " + str((int(nano_ID[1])) * 160) + " -e 200000 -r 5 -l 1 -d NFOV_UNBINNED -c 1080p " + case_path + "/" + "Animal_" + str(case_number) + "_nano_" + server_no + ".mkv"
                    os.system("export DISPLAY=:0")
                else:
                    command = "k4arecorder --external-sync sub --sync-delay " + str((int(nano_ID[1])) * 160) + " -e 200000 -r 5 -l 1 -d WFOV_UNBINNED -c 1080p " + case_path + "/" + "Animal_" + str(case_number) + "_nano_" + server_no + ".mkv"
                    os.system("export DISPLAY=:0")
        else:
            if master_ID == nano_ID:
